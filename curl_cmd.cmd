...
job_id :
curl localhost:5000/models/images/classification/classify_many.json -XPOST -F job_id=20180705-154809-8bc1 -F image_list=@D:\MINST\Extraction\extracted.txt > D:\Crawler\lenet_200.json
...
# create model with adadelta  : difference in solver type
curl localhost:5000/models/images/classification.json -b digits.cookie -XPOST -F method=standard -F standard_networks=lenet -F train_epochs=1 -F framework=caffe -F model_name=lenet_1 -F dataset=20180706-111701-2e5b
